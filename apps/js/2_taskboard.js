        ...
        success: function (data) {
            ...
            if (json.length == 0) {
                ...
                for (i = 0; i < json.length; i++) {
                    ...
                    myTaskboardTicket.row.add([Indikator, json[i].RowNumber, json[i].TicketNumber, json[i].NamePIC, json[i].CategoryName, json[i].SLA, json[i].UsedDaySLAOK, TrxPosition, TrxParam, ConverTanggal, urlAction]).draw(false);
