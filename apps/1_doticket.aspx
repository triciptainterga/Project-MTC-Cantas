                        ...
                        <div class="box bg-white">
                            <div class="box-body">
                                ...
                                <ul class="nav nav-pills rounded nav-justified">
                                    ...
                                    <li class="nav-item"><a href="#navpills-5" class="nav-link" data-toggle="tab" aria-expanded="true" onclick="TableVehicle()"><i class="fa fa-automobile"></i>&nbsp;Plate Number</a> </li>
                                </ul>
                            </div>
                            <!-- /.box-body -->
                        </div>
