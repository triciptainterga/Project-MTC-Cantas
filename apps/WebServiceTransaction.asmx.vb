...
Public Class WebServiceTransaction
    ...
    Public Function Insert_TransactionTicket(ByVal TrxUsername As String, ByVal TrxCustomerID As String, ByVal TxtThreadID As String, ByVal TxtAccount As String, ByVal TrxPelapor As String, ByVal TrxPelaporEmail As String,
                                             ...
                                             ByVal TrxSLA As String, ByVal TrxExtendCategory As String, ByVal TrxLayer As String, ByVal TrxThreadID As String, ByVal TrxGenesysID As String, ByVal TxtContactID As String, ByVal TrxIDchannel As String,
                                             ByVal TrxProductName As String, ByVal TrxTollRoadSegment As String) As String
        ...
        Catch ex As Exception
            ...
            strExec = "exec Insert_Transaction " & "'" & TrxCustomerID & "'," & "'" & strTime & "'," & "'" & TrxChannel & "'," & "'" & TrxCategory & "'," & "'" & TrxLevel1 & "'," & "'" & TrxLevel2 & "'," & "'" & TrxLevel3 & "'," & "'" & HttpUtility.UrlDecode(TrxComplaint) & "'," & "'" & HttpUtility.UrlDecode(TrxResponse) & "'," & "'" & TrxSLA & "'," & "'" & TrxStatus & "'," & "'" & TrxUsername & "'," &
                      ...
                      "" & "'" & TrxKejadian & "'," & "'" & TrxPenyebab & "'," & "'" & TrxStatusPelapor & "'," & "'" & TrxPenerimaPengaduan & "'," & "'" & TrxEskalasi & "'," & "'" & TrxLayer & "'," & "'" & strTrxThreadID & "', " & "'" & strTrxGenesysID & "', " & "'" & strTrxContactID & "'," & "'" & TrxExtendCategory & "'," & "'" & strTrxIDchannel & "'," & "'" & TrxProductName & "'," & "'" & TrxTollRoadSegment & "'"
