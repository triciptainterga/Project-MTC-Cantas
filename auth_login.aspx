...
<body class="hold-transition theme-success bg-gradient-success">
                            ...
                            <div class="bg-white-10 rounded5" style="background-color: white;">
                                <div class="content-top-agile p-10 pb-0">
                                    ...
                                    <span class="light-logo">
                                        <img src="cantas.jpg" alt="logo" /></span>
                                    ...
                                    <form id="form1" runat="server">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-dark text-white"><i class="ti-user"></i></span>
                                                </div>
			                            ...
			                            <label for="basic_checkbox_1">Remember Me</label>
                                            ...
                                            <div class="col-12 text-center">
                                                ...
                                                <%--<button type="submit" id="LoginWA" runat="server" class="btn btn-primary btn-rounded mt-10">Login WA</button>--%>
                                            </div>
                                            <!-- /.col -->
                                        </div>
                                    </form>
    ...
    <script src="apps/js/TrmAux.js"></script>
</body>
</html>
